...
<!--            {{ Form::close() }}-->
            ...
            <table class="table">
                ...
                <tr>
                    <td>{{ $package->name }}</td>
                    <td>{{ HTML::link('admin/service-package/' . $package->id, 'View Details', ['class' => 'btn btn-info']) }}</td>
                    <td>{{ HTML::link('admin/delete/service-package/' . $package->id, 'delete', ['class' => 'btn btn-danger']) }}</td>
                </tr>
                @endforeach
                </tbody>
            </table>
