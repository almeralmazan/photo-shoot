        ...
        <div class="col-md-12">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{ $service->name }}</td>
                        <td>{{ HTML::link('admin/service-package/' . $service->id, 'View Details', ['class' => 'btn btn-info']) }}</td>
                        <td>{{ HTML::link('admin/delete/service-package/' . $service->id, 'delete', ['class' => 'btn btn-danger']) }}</td>
                    </tr>
                    @endforeach
                </tbody>
            </table>
