...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="form-group">
            {{ Form::text('gallery_name', null, ['class' => 'form-control', 'placeholder' => 'Gallery Name', 'required'
            => true]) }}
        ...
        <table class="table">
            ...
            <tr>
                ...
                <td>{{ HTML::link('admin/delete/gallery/' . $gallery->id, 'delete', ['class' => 'btn btn-danger']) }}
                </td>
            </tr>
            @endforeach
            </tbody>
